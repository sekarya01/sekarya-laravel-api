...
final class VerificationCodeMailTest extends TestCase
{
    ...
    {
        $mail = new VerificationCodeMail('123456', 'Budi Prasetyo', 15, 'budi@sekarya.test');
        ...
        $recipients = array_map(
            ...
            (array) $mail->envelope()->to,
        );

        $this->assertContains('budi@sekarya.test', $recipients);
    }

    public function test_the_rendered_html_embeds_the_logo_and_shows_the_code(): void
    {
        $html = (new VerificationCodeMail('123456', 'Budi Prasetyo', 15, 'budi@sekarya.test'))->render();
